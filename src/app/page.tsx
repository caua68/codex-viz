      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="flex gap-2">
          <Link
            ...
            aria-label="GitHub"
            className="inline-flex items-center rounded-lg border border-slate-200 bg-white/80 p-2 text-slate-600 hover:bg-white"
          >
            <svg viewBox="0 0 24 24" aria-hidden="true" className="h-4 w-4 fill-slate-700">
